                ...
                <div className="mobile-view mobile-menu">
                    <div className="mobile-menu-inner">
                        ...
                        <div className="drawer-links">
                                ...
                                <li>
                                    ...
                                    {/* <div className="ac-content">
                                        <div className="drawer-submenu">
                                            ...
                                            <NavLink exact to="/Professional-category/" href="javascript:void(0)">Services</NavLink>
                            ...
                            <NavLink className="icon-list" exact to={'/Seller-login/'}><i className="bi bi-box"></i><b>Seller</b>
                        ...
                        <div className="collapse navbar-collapse" id="collapsibleNavbar">
                            {(localStorage.getItem('type') != 2 || localStorage.getItem('type') != 3) && <ul className="navbar-nav mx-auto">
                                <li className="nav-item dropdown megamenu">
                                    <a className="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown">Community</a>
                                ...
                                <li className="nav-item dropdown megamenu">
                                    <NavLink exact to="/Professional-category/" className="nav-link" href="javascript:void(0)"><span>Find Experts</span></NavLink>
                                    {/* <a className="nav-link dropdown-toggle"  href="#" data-toggle="dropdown">Professional</a> */}
                                    {/* <div className="dropdown-menu">
                                        <div className="mega-container four"> */}
                                ...
                                <li className="nav-item dropdown megamenu">
                                    <a className="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown">Store</a>
                                    <div className="dropdown-menu">
                                        <div className="mega-container four">
