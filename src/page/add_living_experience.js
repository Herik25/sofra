...
class LivingExperienceAdd extends Component {
    constructor(props) {
        super(props);
            ...
            .then(res => {
                ...
                if (res_data.status) {
                    ...
                    for (var i = 0; i < multiple_data.length; i++) {
                        ...
                        if (multiple_data[i]['tled_title']) {

                            blank_array.push({
                                text: multiple_data[i]['tled_title']
                            })
                        } else if (multiple_data[i]['tled_desc']) {
                            blank_array.push({
                                desc: multiple_data[i]['tled_desc']
                            })
                        } else if (multiple_data[i]['tled_image']) {
                            blank_array.push({
                                // image: multiple_data[i]['tled_image'],
                                image_display: multiple_data[i]['tled_image'],
                            })
                    ...
                    //         blank_array1.push(user_tag[i]['pt_tag']
                    //         )

                    //     }
                    // }
                    // console.log(blank_array1)


                    this.setState({
                        form_data: {
                            ...this.state.form_data,
                            work: work.living_work,
                            time_id: work.living_time,
                            project_name: work.living_name,
                            category_id: work.living_category,
                            short_desc: work.living_short_desc,
                            image: work.living_image,
    ...
    handleGetTagData(event) {
        ...
        // console.log(this.state.form_data['multiple_data']);
        $(".t_hotSpot").remove();
    ...
    onItemClick() {
        if (!this.validator.allValid()) {
            ...
            api_option.url = 'save_living_experience';
            const formData = new FormData();
            ...
            //formData.append('pro_array', JSON.stringify(pro_array));
            api_option.data = formData;
            axios(api_option)
                .then(res => {
    ...
    handleSaveData(event) {
        ...
        if (!this.validator.allValid()) {
            ...
            //         }
            //     });
            //     pro_array.push({ position: position, product: product })
            // });
            ...
            <>
                ...
                <div className="mobile-view mobile-header">
                    <div className="mobile-header-left">
                        <h1 className="md-title m-0">Add Living experience</h1>
                    </div>
                ...
                <form id="example-form" onSubmit={this.handleSaveData}>
                    <div className="addproject-page">
                        <div className="container container-small">
                            <h1 className="md-title-2 web-view">Add Living experience</h1>
                            <div className="createProject-wrapper">

                                <div className="text-grid">
                                    <div className="form-group">
                                        <label>Living experience Name</label>
                                        ...
                                        {this.validator.message('Living experience name', this.state.form_data.project_name, 'required')}
                                    </div>
                                </div>

                                <div className="form-group">
                                    <label>Living experience Tag</label>
                                    <Select2
                                        multiple
                                        name="p_tag"
                                ...
                                <div className="text-grid two">

                                    <div className="form-group">
                                        <label>Living experience Category</label>
                                ...
                                <div className="uploadProjectBanner">
                                    <div className="form-group">
                                        <label>Living experience Main Banner<span style={{ color: "red" }}>(For best resolution upload size is 1960*600)</span></label>
...
export default LivingExperienceAdd;
